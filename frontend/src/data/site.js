export const site = {
    name: 'Reason Dahal',
    eyebrow: 'Open to internships + freelance',
    headline: 'I build mobile apps that help businesses grow',
    subheadline:
      'Full-stack mobile developer working with Flutter, Node.js, and MongoDB — turning ideas into apps people actually use.',
